...
class Repository(GitHubCore):
    ...
    def _update_attributes(self, repo):
        ...
        #: main (default) branch for the repository
        self.main_branch = repo.get('main_branch', '')
    ...
    def archive(self, format, path='', ref='main'):
    ...
    def create_pull(self, title, base, head, body=None):
        ...
        :param str base: (required), e.g., 'main'
    ...
    def create_ref(self, ref, sha):
        ...
        :param str ref: (required), fully qualified name of the reference,
            e.g. ``refs/heads/main``. If it doesn't start with ``refs`` and
